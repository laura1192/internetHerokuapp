...
describe("Dropdown", () => {
  it("Verify Dropdown Page ", () => {
    ...
    cy.get(LOCATORS.example).find(dropdownPage.LOCATORS.dropdown).should("be.visible");
  });
  it("Verify selection function", () => {
    ...
    cy.get(LOCATORS.example).find(dropdownPage.LOCATORS.dropdown).select(option);
    cy.get(LOCATORS.example)
      .find(dropdownPage.LOCATORS.dropdown)
      .find("Option")
      .last()
